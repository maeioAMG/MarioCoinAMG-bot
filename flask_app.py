...
try:
    ...
    def broscute_command(message):
        response = (
            ...
            "🎯 Bot funcționează 24/7 pe PythonAnywhere!"
        )
    ...
    def callback_handler(call):
        if call.data == "lang_ro":
            response = (
                ...
                "🎮 Hosting gratuit pe PythonAnywhere"
            )
...
def index():
    ...
    return f"""
    <h1>🚀 MarioCoinAMG Bot - PythonAnywhere</h1>
    <p>Status: {status}</p>
...
@app.route('/mariocoin_webhook_secret_2025', methods=['POST'])
...
def set_webhook():
    ...
    webhook_url = "https://mariobotamg.pythonanywhere.com/mariocoin_webhook_secret_2025"
